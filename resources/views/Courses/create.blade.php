        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900"><a class="text-decoration-none" href="{{route("course.index")}}">Course</a></h3>
                    <p class="mt-1 text-sm text-gray-600">
                       Here you Create Courses
                    </p>
                </div>
            </div>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-6">
                                ...
                                <input type="text" name="course_name" value="{{old('course_name')}}" id="course_name" autocomplete="given-name" placeholder="Course Name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('course_name') is-invalid
                               @enderror">
                                @error('course_name')
