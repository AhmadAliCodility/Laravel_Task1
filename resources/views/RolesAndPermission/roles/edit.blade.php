                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <input type="text" name="name" value="{{$role->name ?? old('name')}}" id="name"
                                           autocomplete="given-name" placeholder="Role Name"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('name') is-invalid
                                       @enderror">
                                    @error('name')
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <select name="role" id="" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('role') is-invalid
                                       @enderror">
                                    ...
                                    @foreach($permissions as $permission)
                                        <div class="flex items-start">
                                            <div class="flex items-center h-5">
                                                <input id="comments" name="permission[]" value="{{$permission->id}}"
